...
public class ElevatorTest {
    ...
    void test_elevator_increase_capacity_when_elevator_enters_a_src_floor_for_first_time() {
        ...
        assertTrue(event1.getSrcReached()); // Check that getSrcReached is trigger to indicate it reached src floor
        assertFalse(event2.getSrcReached());// Check that other events have not been altered
        assertFalse(event3.getSrcReached());
    }
    ...
    void test_elevator_decrease_and_increase_capacity_when_elevator_enters_a_dest_floor_and_src_floor() {
        ...
        assertTrue(event2.getSrcReached());
    }
